 ...
 */
class CRM_Blocklist_Upgrader_Base {

  /**
   * @var CRM_Blocklist_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Blocklist_Upgrader(
        'blocklist',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Blocklist_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Blocklist_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
